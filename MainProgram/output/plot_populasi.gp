...
plot 'hasil_rungekutta.txt' using 1:2 with linespoints ls 1 title 'Simulasi', \
     'data_aktual.txt' using 1:2 with points pt 6 ps 1.5 lc rgb 'black' title 'Data Aktual'
